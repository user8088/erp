...
export default function ConsolidatedFinancialStatementPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-full py-4">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Consolidated Financial Statement</h1>
        <p className="mt-1 text-sm text-gray-500">
          View consolidated financial statements across multiple companies (future feature).
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
        <div className="text-sm text-gray-500">
          Consolidated Financial Statement report will be available once multi-company support is
          implemented.
        </div>
      </div>
    </div>
