...
export const rentalApi = {
  ...
  // Bad Debt Write-off
  async writeOffBadDebt(agreementId: number, payload: { notes?: string }): Promise<{ message: string }> {
    return await apiClient.post<{ message: string }>(`/rentals/agreements/${agreementId}/write-off`, payload);
  },
