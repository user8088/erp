...
export default function TrialBalanceForPartyPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-full py-4">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Trial Balance for Party</h1>
        <p className="mt-1 text-sm text-gray-500">
          View trial balance for a specific customer or supplier.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
        <div className="text-sm text-gray-500">
          Trial Balance for Party report will be available once the backend API is implemented.
        </div>
      </div>
    </div>
  );
