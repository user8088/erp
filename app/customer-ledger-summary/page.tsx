...
export default function CustomerLedgerSummaryPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto min-h-full py-4">
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-gray-900">Customer Ledger Summary</h1>
        <p className="mt-1 text-sm text-gray-500">
          View outstanding balances and payment history for all customers.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
        <div className="text-sm text-gray-500">
          Customer Ledger Summary report will be available once the backend API is implemented.
        </div>
      </div>
    </div>
  );
