    ...
    <div className="max-w-7xl mx-auto min-h-full py-4">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">
          View cash inflows and outflows from operating, investing, and financing activities.
        </p>
      </div>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-8 text-center">
        <div className="text-sm text-gray-500">
          Cash Flow Statement report will be available once the backend API is implemented.
        </div>
      </div>
    </div>
  );
